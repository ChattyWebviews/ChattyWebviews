...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ChattyWebviews.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tdermendjiev/ChattyWebviews'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tdermendjiev' => 'tdermendjievft@gmail.com' }
  s.source           = { :git => 'https://github.com/tdermendjiev/ChattyWebviews.git', :tag => s.version.to_s }
